...
Procedure Vd_CreateToolbar()
  ...
  If VdOptions\ToolBarVertical = 0
    ...
    If ContainerGadget(#G_ToolBarVD,0,0,winw,hh)
      ...
      ; create tools
      AddGadget(#G_ToolVDNew, #Gad_BtnImg, x1,y1,h2,h2,"",0,ImgVd(#Img_New),Lang("New Document"))  : x1+h2+a
      AddGadget(#G_ToolVDOpen, #Gad_BtnImg, x1,y1,h2,h2,"",0,ImgVd(#Img_open),Lang("Open Document"))  : x1+h2+a
      AddGadget(#G_ToolVDsave, #Gad_BtnImg, x1,y1,h2,h2,"",0,ImgVd(#Img_save),Lang("Save Document"))  : x1+h2+a
